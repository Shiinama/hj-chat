...
export default async function request<T>(options: RequestOptions) {
  ...
  if (notNeedLogin) {
    Authorization =
      'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..RRWWiD8EY06IjT_qDRWdGcDCMmVw-zTJpwAHPi3t89U'
  } else {
