...
export default async function request<T>(options: RequestOptions) {
  ...
  if (notNeedLogin) {
    Authorization =
      'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..tAx1T_aCFZC7GYkspiGwKrS8148dMi2929IeOPvopTo'
  } else {
