...
export const useSocketIo = () => {
  ...
  const token =
    userBaseInfo?.token ??
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..RRWWiD8EY06IjT_qDRWdGcDCMmVw-zTJpwAHPi3t89U'
  const ready = (): boolean => {
