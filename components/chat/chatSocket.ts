...
class ChatService {
  ...
  init() {
    ...
    this.socket = io(`${SysConfig.baseUrl}/chat`, {
      ...
      auth: {
        token:
          'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJNeVNoZWxsVGVzdCIsInN1YiI6MzA2LCJhdWQiOiJNeVNoZWxsVGVzdCIsIm5iZiI6MCwiaWF0IjoxNjgzMDMyMzc3Mjg1LCJqdGkiOiI5OWIzM2U2Zjk0MDg0OWY0ODVhN2M3ZjAyYTM3MGRhNiIsInNlY3VyaXR5U3RhbXAiOiI1NGMwYWY2Mzk5NTQ0M2EzYjViNGU0MzU4MGNhYjU3NSIsImV4cCI6MTY4MzAzNDk2OTI4NX0.dkTLwDLtJdV186wZyEoQugSjFPZBPePGdWT8TrdarSk',
      },
    })
